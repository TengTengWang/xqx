...
import com.xqx.zuul.dao.IUserDataFeignClient.UserDataFeignClientFallbackFactory;
 ...
 *
 */
@FeignClient(name = "xqx-user-data", fallbackFactory = UserDataFeignClientFallbackFactory.class)
